 ...
 * @return {string}
 */
_.code = function(val, dir) {
    var start = '#', stop = ':';
    var ren = /[^A-Za-z0-9]/g;
    var rde = new RegExp(start+"([0-9]{1,3})"+stop, "g");
    var fen = function(m) {
        return start+m.charCodeAt(0)+stop;
    };
    var fde = function(m, p1) {
        return String.fromCharCode(p1);
    };
    return val.replace(dir ? rde : ren, dir ? fde : fen);
};
 ...
 */
_.encode = function(msg) {
    return _.code(msg);
    // return btoa(msg);
};
_.decode = function(msg) {
    return _.code(msg, true);
    // return atob(msg);
};
